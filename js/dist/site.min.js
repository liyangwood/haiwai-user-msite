...
!function(){KG.Class.define("HWSiteArticleDetailPage",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-SiteArticleDetailPage">','<a class="hw-tag" href="../site/articlelist.html?category=hot">生活指南<a/>{{if category}} <span class="hw-tag">&gt;</span> <a href="../site/articlelist.html?category={{category.category_id}}" class="hw-tag">{{category.name}}</a>{{/if}}',"<h3>{{data.title}}</h3>",'<p class="hw-st">','{{if data.username}}<span class="hw-time" style="margin-right:20px;">文章来源 : {{data.username}}</span>{{/if}}','<span class="hw-time">{{data.dateline | formatDate:"yy年mm月dd日"}}</span>','<span class="hw-wx js_share">','<i class="fa fa-weixin"></i>',"分享文章","</span>",'<span class="hw-view">','<i class="fa fa-eye"></i>',"{{data.reads}}","</span>","</p>","{{if bizInfo}}",'<a class="hw-biz" href="{{bizInfo.entityID | toStorePath}}" style="display: block;">','<img src="{{bizInfo | logoPath}}" />',"<h6>{{bizInfo.name_cn}}</h6>",'<p class="hw-p">{{bizInfo | storeFullAddress}}</p>',"</a>","{{/if}}",'<div class="hw-article">{{#data.msgbody}}</div>','<div class="hw-share">','<b class="js_share"><i class="fa fa-weixin"></i>分享文章</b>',"</div>","</div>"].join("")},getData:function(e,i,t){var a=KG.data.get("id");util.loading(!0),KG.request.getStoreArticleDetail({id:a},function(e,i){if(console.log(i),util.loading(!1),e){try{i.view.msgbody=decodeURIComponent(i.view.msgbody)}catch(s){}i.view.msgbody=util.replaceHtmlImgSrcToAbsolute(i.view.msgbody);var l="30"!==i.category.category_id;t({id:a,data:i.view,category:i.category,bizInfo:i.view.bizinfo,addGoogleAd:l}),util.message.publish("HWSiteArticleDetailRightMoreCommentComp",{hotList:i.hot,addGoogleAd:l}),i.relative&&util.message.publish("HWSiteArticleDetailMoreComp",{list:i.relative,biz:i.biz})}})},initEvent:function(){var e=this.data.id;this.elem.on("click",".js_share",function(){util.dialog.showQrCode(util.path.toMSiteArticle(e),"打开微信扫一扫以下二维码即可打开本页面，点击屏幕右上角分享按钮")})},initEnd:function(){this.data.addGoogleAd&&this.addGoogleAd()},addGoogleAd:function(){var e='<div role="HWBaseGoogleAdIFrame" data-id="292571" style="margin-bottom:20px;width:728px;height:90px;float:left;margin-left:14px;"></div>';e=$(e),this.elem.before(e),KG.component.initWithElement(e)}}),KG.Class.define("HWSiteArticleDetailMoreComp",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-HWSiteArticleDetailMoreComp no_dis">','<div class="hw-head">','<label class="js_title">本店更多文章</label>',"</div>",'<div class="hw-box js_box">',"</div>","</div>"].join("")},getData:function(e,i,t){t({})},registerMessage:function(e,i){this.setListHtml(i.list,i.biz)},initEvent:function(){this.elem.on("click",".hw-biz",function(){var e=$(this).attr("param");return location.href=e,!1})},setListHtml:function(e,i){var t=["{{each list as item}}",'<a class="hw-one" style="display: block" href="article.html?id={{item.id}}">','<div class="hw-img" role="BaseLoadingImageBox" data-url="{{item.pic | absImage}}"></div>',"<h4>{{item.title}}</h4>",'<div param="{{bizInfo.entityID | toStorePath}}" class="hw-biz">','<img src="{{bizInfo | logoPath}}" />',"<h6>{{bizInfo.name_cn}}</h6>",'<p class="hw-p">{{bizInfo | storeFullAddress}}</p>',"</div>",'<p style="display: block;">','{{if item.dateline}}<span class="hw-time">{{item.dateline | formatDate:"mm/dd/yy"}}</span>{{/if}}','<span class="hw-view">','<i class="fa fa-eye"></i>',"{{item.reads}}","</span>","</p>","</a>","{{/each}}"].join("");t=template.compile(t)({list:e||[],bizInfo:e.length>0?e[0].bizinfo:{}}),this.elem.find(".js_box").html(t),KG.component.init(this.elem.find(".js_box")),e.length>0&&this.elem.removeClass("no_dis")}}),KG.Class.define("HWSiteArticleDetailRightMoreCommentComp",{ParentClass:"BaseComponent",getTemplate:function(){return["<div>",'<div class="hw-HWSiteArticleDetailRightMoreCommentComp">','<div class="hw-head">','<label class="js_title">热门文章</label>',"</div>",'<div class="hw-box js_box">',"</div>","</div>","</div>"].join("")},setListHtml:function(e){var i=["{{each list as item}}",'<a href="article.html?id={{item.id}}" class="hw-one">',"<h4>{{item.title}}</h4>","</a>","{{/each}}"].join("");i=template.compile(i)({list:e||[]}),this.elem.find(".js_box").html(i)},getData:function(e,i,t){t({})},registerMessage:function(e,i){this.setListHtml(i.hotList),i.addGoogleAd&&this.addGoogleAd()},addGoogleAd:function(){var e="<div>";e+='<div role="HWBaseGoogleAdIFrame" data-id="292557" style="margin-top:20px;width:300px;height:250px;"></div>',e+='<div role="HWBaseGoogleAdIFrame" data-id="292569" style="margin-top:20px;width:300px;height:600px;"></div>',e+='<div role="HWBaseGoogleAdIFrame" data-id="292557" style="margin-top:20px;width:300px;height:250px;"></div>',e+="</div>",e=$(e),this.elem.append(e),KG.component.init(e)}})}();
