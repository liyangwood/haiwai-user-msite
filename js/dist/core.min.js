...
"use strict";!function(){var e=1,t={};_.extend(t,_),t.extend(t,{formatDate:function(e,t){function a(e){return 10>e?"0"+e:e}10===e.toString().length&&(e=1e3*parseInt(e));var i=new Date(e),o=i.getFullYear(),l=a(i.getMonth()+1),n=a(i.getDate()),s=a(i.getHours()),d=a(i.getMinutes()),c=a(i.getSeconds());return t.replace("yy",o).replace("mm",l).replace("dd",n).replace("h",s).replace("m",d).replace("s",c)},getUuid:function(){return"uuid_"+e++},uploadImage:function(e,t){if(e){var a=new FileReader;a.onload=function(e){var a=e.target.result;KG.request.uploadImage({image:a},function(e,a){e&&t(a.files[0])})},a.readAsDataURL(e)}}}),t.message={register:function(e,t){$("body").unbind(e).bind(e,t)},publish:function(e,t){$("body").trigger(e,t)}},t.dialog={init:function(){var e=['<div class="modal fade" id="kg_modal_dialog" tabindex="-1" role="dialog">','<div class="modal-dialog" role="document">','<div class="modal-content box">',"</div>","</div>","</div>"].join("");e=$(e),e.on("hidden.bs.modal",function(){var t=e.find(".box");t.find(".js_yes").unbind("click"),t.empty()}),e.appendTo("body")},get:function(e){$("#kg_modal_dialog").length<1&&t.dialog.init();var a=$("#kg_modal_dialog");if(!e)return a;var i=t.extend({title:"信息提示",body:"点击确认，我们将为您删除这个店铺的所有信息，包括基本信息，图片，店铺评级和评论等，并且不能再找回这些信息，请谨慎操作。",foot:!0,type:"confirm",YesText:"确认",YesFn:t.noop,NoText:"取消",end:null},e),o=['{{if type!=="toast"}}','<div class="modal-header">','<button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>',"</div>","{{/if}}",'<div class="modal-body">',"{{if title}}",'<h4 class="hw-title">{{title}}</h4>',"{{/if}}",'{{if body}}<div class="hw-body">{{#body}}</div>{{/if}}',"</div>","{{if foot}}",'<div class="modal-footer">','<button type="button" class="hw-btn hw-light-btn" data-dismiss="modal">{{NoText}}</button>','{{if YesText}}<button type="button" class="hw-btn hw-blue-btn js_yes">{{YesText}}</button>{{/if}}',"</div>","{{/if}}"].join("");return o=template.compile(o)(i),a.find(".box").html(o),a.find(".js_yes").click(i.YesFn),a.attr("class","modal fade"),e["class"]&&a.addClass(e["class"]),a},show:function(e){var a=t.dialog.get(e);a.modal()},hide:function(){var e=t.dialog.get();e.modal("toggle")},showFocusImage:function(e,a){var i=['<div id="cb_cccc" class="carousel slide" data-ride="carousel">','<ol class="carousel-indicators">',"{{each list}}",'<li data-target="#cb_cccc" data-slide-to="{{$index}}" class="{{if index==$index}}active{{/if}}"></li>',"{{/each}}","</ol>",'<div class="carousel-inner" role="listbox">',"{{each list as url}}",'<div class="item {{if index==$index}}active{{/if}}">','<img src="{{url}}">',"</div>","{{/each}}","</div>",'<a class="left carousel-control" href="#cb_cccc" role="button" data-slide="prev">','<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>','<span class="sr-only">Previous</span>',"</a>",'<a class="right carousel-control" href="#cb_cccc" role="button" data-slide="next">','<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>','<span class="sr-only">Next</span>',"</a>","</div>"].join("");i=template.compile(i)({list:a,index:e}),t.dialog.show({body:i,foot:!1,"class":"hw-carousel",title:""})},confirm:function(e){t.dialog.show({title:e.msg,body:!1,NoText:"取消",YesText:e.YesText,"class":"hw-confirm",YesFn:e.YesFn})}},t.alert=function(e){t.dialog.show({body:e,NoText:"确定",YesText:!1})},t.url={param:function(e,t){t=t||location.search,e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var a=new RegExp("[\\?&]"+e+"=([^&#]*)"),i=a.exec(t);return null===i?"":decodeURIComponent(i[1].replace(/\+/g," "))}},window.util=KG.util=t}(),function(){template.helper("formatDate",function(e,t){return util.formatDate(e,t||"yy年mm月dd日 h:m:s")}),template.helper("storeFullAddress",function(e){return e.address+", "+e.city+", "+e.state+" "+e.zip}),template.helper("defaultUserImage",function(e){return e?e:KG.user.get("defaultImage")})}();
...
!function(){KG.Class.define("MybizCreateStoreStepInfo",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-stepinfo {{step}}">','<div class="c c1"><i class="fa fa-check"></i></div>','<div class="d d1"></div>','<div class="c c2"><i class="fa fa-check"></i></div>','<div class="d d2"></div>','<div class="c c3"><i class="fa fa-check"></i></div>','<p class="p p1">基本信息</p>','<p class="p p2">更多描述</p>','<p class="p p3">上传图片</p>',"</div>"].join("")},defineProperty:function(){return{step:{defaultValue:"step1"}}},getData:function(e,t,a){a({step:this.prop.step})}}),KG.Class.define("MybizStoreInfoFormStep1",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-comp-MybizStoreInfoFormStep1">','<div class="js_name" role="BaseInput" data-label="店铺名称" data-require="true" placeholder="e.g. 小肥羊Fremont店 （请尽量用中文名，分店请尽量添加城市名）"></div>','<div class="js_tel" role="BaseInput" data-label="营业电话" data-require="true" placeholder="e.g. 5107687776"></div>','<div class="js_cat" data-label="服务类别" data-require="true" role="BaseSelectInput" init-self="true" placeholder="请选择一种类别"></div>','<div class="js_address" role="BaseInput" data-label="店铺地址" placeholder="街道地址"></div>','<div style="margin-left: 0;" class="js_zip hw-inline" role="BaseInput" data-require="true" data-label="邮编" placeholder="e.g. 94536"></div>','<div class="js_zip hw-inline" data-delbtn="true" role="BaseInput" data-require="true" data-label="城市"></div>','<div class="js_zip hw-inline" data-delbtn="true" role="BaseInput" data-require="true" data-label="州/省"></div>','<div class="form-group js_tag">',"<label>营业特色</label>",'<div class="hw-tagbox">',"</div>","</div>",'<button style="float: right;" class="js_btn hw-btn hw-blue-btn">下一步</button>',"<div>"].join("")},getData:function(e,t,a){var i=[function(){return KG.request.getAllStoreCategoryList({})}];KG.request.defer(i,function(e){a({catList:e})})},setJqVar:function(){return{tagBox:this.elem.find(".hw-tagbox"),btn:this.elem.find(".js_btn")}},initEvent:function(){this.jq.btn.click(function(){location.href="createStore_2.html"})},initEnd:function(){var e=this,t=this.elem.find(".js_cat");this.jq.cat=KG.component.initWithElement(t,{list:this.data.catList,getEachHtml:function(){return"{{item.name}}"},clickCallback:function(t){e.switchCategory.call(e,t)}})},switchCategory:function(e){var t=e.pk_id,a=this;KG.request.getAllStoreTagByCategory({catId:t},function(e,t){e&&a.setTagHtml(t)})},setTagHtml:function(e){var t='{{each list as item}}<label><input type="checkbox" uid="{{item.pk_id}}" />{{item.name}}</label>{{/each}}';t=template.compile(t)({list:e}),this.jq.tagBox.html(t)}}),KG.Class.define("MybizStoreInfoFormStep2",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-comp-MybizStoreInfoFormStep2">','<div class="hw-dym">',"<span>是否接受预定</span>",'<label><input type="radio" class="radio-inline" name="ra_aaa" />是</label>','<label><input type="radio" class="radio-inline" name="ra_aaa" />否</label>',"</div>",'<div class="hw-dym">',"<span>是否有停车位</span>",'<label><input type="radio" class="radio-inline" name="ra_bbb" />是</label>','<label><input type="radio" class="radio-inline" name="ra_bbb" />否</label>',"</div>",'<div class="hw-dym">',"<span>是否提供Wi-Fi</span>",'<label><input type="radio" class="radio-inline" name="ra_ccc" />是</label>','<label><input type="radio" class="radio-inline" name="ra_ccc" />否</label>',"</div>",'<div class="js_money" data-label="价位" role="BaseSelectInput" init-self="true" placeholder="请选择一种价位"></div>','<div class="js_link" role="BaseInput" data-label="店铺网址" placeholder="e.g. www.xiaofeiyang.com"></div>','<div class="js_wx" role="BaseInput" data-label="微信号" placeholder="e.g. xiaofeiyang"></div>','<div class="form-group">','<label class="lab">店铺描述</label>','<textarea style="height: 150px;" class="form-control hw-area js_desc"></textarea>',"</div>",'<a class="hw-btn hw-light-btn" style="border: none;font-weight: 400;" href="createStore.html">返回上一步</a>','<button style="float: right;" class="js_btn hw-btn hw-blue-btn">下一步</button>',"<div>"].join("")},setJqVar:function(){return{btn:this.elem.find(".js_btn")}},initEnd:function(){var e=["100-200","200-300","300-400","大于400"];this.jq.money=KG.component.initWithElement(this.elem.find(".js_money"),{list:e,clickCallback:function(e){console.log(e)}})},initEvent:function(){this.jq.btn.click(function(){location.href="createStore_3.html"})}}),KG.Class.define("UploadStoreImage",{ParentClass:"BaseUploadImage",getTemplate:function(){return["<div>",'<div class="hw-img-box">','<img class="js_img" src="{{image}}" />','<b class="js_del">删除</b>',"</div>",'<button data-loading-text="正在上传..." class="hw-btn js_btn">从电脑上传图片</button>','<input type="file" />',"</div>"].join("")},getData:function(e,t,a){a({image:this.prop.image})},setJqVar:function(){return{delBtn:this.elem.find(".js_del")}},initEvent:function(){this.callParent("initEvent");var e=this.elem.find(".js_del");this.elem.find(".hw-img-box").hover(function(){e.slideDown(200)},function(){e.slideUp(200)});var t=this.jq;t.delBtn.click(function(){t.img.attr("src",KG.user.get("defaultImage"))})}}),KG.Class.define("MybizUploadStoreImage",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-comp-MybizUploadStoreImage">','<div class="hw-add js_add">','<i class="icon fa fa-plus-square-o"></i>',"<p>添加新图片</p>",'<input class="js_input" type="file" />',"</div>","</div>"].join("")},setJqVar:function(){return{add:this.elem.find(".js_add"),fileInput:this.elem.find(".js_input")}},getData:function(e,t,a){var i=(KG.user.get("image"),t.list);a({list:i})},initEvent:function(){var e=this;this.jq.fileInput.change(function(){var t=this.files[0];e.uploadImageFn(t,function(t){e.addNewImage(t)}),$(this).val("")}),this.elem.click(function(t){var a=$(t.target),i=a.closest(".js_del");return i.length>0?(util.dialog.confirm({YesText:"删除",msg:"您确定要删除这张照片吗？",YesFn:function(){e.deleteImage(i),util.dialog.hide()}}),!1):(i=a.closest(".js_img"),i.length>0?(e.showBigImage(i.find("img").attr("src")),!1):void 0)})},showBigImage:function(e){var t=this.getImageList(),a=util.indexOf(t,e);util.dialog.showFocusImage(a,t)},getImageList:function(){var e=this.elem.find(".js_img");return util.map(e,function(e){var t=$(e);return t.find("img").attr("src")})},getValue:function(){return this.getImageList()},deleteImage:function(e){var t=e.closest(".js_img");t.remove()},getEachHtml:function(e){var t=['<div class="hw-one js_img">','<img src="{{url}}" />','<b class="js_del">删除</b>',"</div>"].join("");return template.compile(t)({url:e})},uploadImageFn:function(e,t){util.uploadImage(e,function(e){var e=KG.config.SiteRoot+e;t(e)})},addNewImage:function(e){var t=this.getEachHtml(e);this.jq.add.after(t)},initEnd:function(){var e=this,t=this.data.list;util.each(t,function(t){e.addNewImage(t)})}}),KG.Class.define("MybizStoreInfoFormStep3",{ParentClass:"BaseComponent",getTemplate:function(){return['<div class="hw-comp-MybizStoreInfoFormStep3">','<div class="form-group">','<label class="lab">店铺Logo</label>','<p class="hw-img-p">店铺／专属页Logo图片是重要的品牌识别标识，建议您上传店铺Logo或职业头像，以增加专业性。该Logo也将用于您的店铺／专属页与用户互动的头像，如回复评论、发布文章、活动。 </p>','<div class="hw-upload" role="UploadStoreImage"></div>',"</div>",'<div class="hw-line"></div>','<div class="form-group">','<label class="lab">店铺图片</label>','<div class="js_image" role="MybizUploadStoreImage" init-self="true"></div>',"</div>",'<a class="hw-btn hw-light-btn" style="float: left;border: none;font-weight: 400;" href="createStore_2.html">返回上一步</a>','<button style="float: right;" class="js_btn hw-btn hw-blue-btn">完成</button>',"</div>"].join("")},getData:function(e,t,a){a({})},initEnd:function(){this.image=KG.component.initWithElement(this.elem.find(".js_image"),{list:this.data.imageList||[KG.user.get("image")]})}})}();