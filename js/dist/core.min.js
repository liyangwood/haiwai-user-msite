"use strict";(function(){this.KG&&(this._KG=KG),this.KG={}}).call(window),function(){var t="http://beta.haiwai.com";KG.config={root:"/haiwai-user-msite",SiteRoot:t,ApiRoot:t+"/service/api/"},KG.Const={};var i={image:KG.config.root+"/image/user_default.png",defaultImage:KG.config.root+"/image/user_default.png",email:"haiwai@chinagate.com",userid:10051,tel:"5735769567",token:"7e68db968c5e8e36872770b0bdcf342f",isLogin:!0};KG.user={get:function(t){return t?i[t]:i}};var e={};KG.data={get:function(t){return t?e[t]:e},add:function(t){util.extend(e,t||{})}}}();
