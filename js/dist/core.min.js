"use strict";(function(){this.KG&&(this._KG=KG),this.KG={}}).call(window),function(){var i="http://beta.haiwai.com";KG.config={root:"/haiwai-user-msite",SiteRoot:i,ApiRoot:i+"/service/api/",MD5_KEY:"m.y^w8oP01K#gs"},KG.Const={};var t={image:KG.config.root+"/image/user_default.png",defaultImage:KG.config.root+"/image/user_default.png",email:"liyang@chinagate.com",userid:14678,tel:"5735769567",token:"5847ac0c8efb8552d1b7c42a4c3f2418",isLogin:!0};KG.user={get:function(i){return i?t[i]:t},login:function(i,e,n){var o=function(i,e){e.pk_id&&(t.userid=e.pk_id,t.token=e.token,t.email=e.email,KG.request.getUserDetailInfo({},function(i,t){console.log(t)}))};KG.request.login(i,o,n)}};var e={};KG.data={get:function(i){return i?e[i]:e},add:function(i){util.extend(e,i||{})}}}();
