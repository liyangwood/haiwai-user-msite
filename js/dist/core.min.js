...
"use strict";!function(){var e=1,t={};_.extend(t,_),t.extend(t,{addUserIdToRequestData:function(e){return e=e||{},e.userid=KG.user.get("userid"),e.token=KG.user.get("token"),e},formatDate:function(e,t){function a(e){return 10>e?"0"+e:e}10===e.toString().length&&(e=1e3*parseInt(e));var o=new Date(e),i=o.getFullYear(),n=a(o.getMonth()+1),s=a(o.getDate()),l=a(o.getHours()),d=a(o.getMinutes()),c=a(o.getSeconds());return t.replace("yy",i).replace("mm",n).replace("dd",s).replace("h",l).replace("m",d).replace("s",c)},getUuid:function(){return"uuid_"+e++},uploadImage:function(e,t){if(e){var a=new FileReader;a.onload=function(e){var a=e.target.result;KG.request.uploadImage({image:a},function(e,a){e&&t(a.files[0])})},a.readAsDataURL(e)}},getQrCode:function(e,t){return t=t||240,"https://api.qrserver.com/v1/create-qr-code/?size="+t+"x"+t+"&data="+encodeURIComponent(e)}});var a={};t.message={register:function(e,t){var o=function(o,i){i=a[e]?a[e].data:i,t(o,i)};if($("body").unbind(e).bind(e,o),a[e]){var i=a[e];t(null,i.data)}},publish:function(e,t){a[e]={data:t},$("body").trigger(e,t)}},t.dialog={init:function(){var e=['<div class="modal fade" id="kg_modal_dialog" tabindex="-1" role="dialog">','<div class="modal-dialog" role="document">','<div class="modal-content box">',"</div>","</div>","</div>"].join("");e=$(e),e.on("hidden.bs.modal",function(){var t=e.find(".box");t.find(".js_yes").unbind("click"),t.empty()}),e.appendTo("body")},get:function(e){$("#kg_modal_dialog").length<1&&t.dialog.init();var a=$("#kg_modal_dialog");if(!e)return a;var o=t.extend({title:"信息提示",body:"点击确认，我们将为您删除这个店铺的所有信息，包括基本信息，图片，店铺评级和评论等，并且不能再找回这些信息，请谨慎操作。",foot:!0,type:"confirm",YesText:"确认",YesFn:t.noop,NoText:"取消",end:null},e),i=['{{if type!=="toast"}}','<div class="modal-header">','<button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>',"</div>","{{/if}}",'<div class="modal-body">',"{{if title}}",'<h4 class="hw-title">{{title}}</h4>',"{{/if}}",'{{if body}}<div class="hw-body">{{#body}}</div>{{/if}}',"</div>","{{if foot}}",'<div class="modal-footer">','<button type="button" class="hw-btn hw-light-btn" data-dismiss="modal">{{NoText}}</button>','{{if YesText}}<button type="button" class="hw-btn hw-blue-btn js_yes">{{YesText}}</button>{{/if}}',"</div>","{{/if}}"].join("");return i=template.compile(i)(o),a.find(".box").html(i),a.find(".js_yes").click(function(e){o.YesFn(function(){t.dialog.hide()},e)}),a.attr("class","modal fade"),e["class"]&&a.addClass(e["class"]),a},show:function(e){var a=t.dialog.get(e);a.modal()},hide:function(){var e=t.dialog.get();e.modal("hide")},showFocusImage:function(e,a){var o=['<div id="cb_cccc" class="carousel slide" data-ride="carousel">','<ol class="carousel-indicators">',"{{each list}}",'<li data-target="#cb_cccc" data-slide-to="{{$index}}" class="{{if index==$index}}active{{/if}}"></li>',"{{/each}}","</ol>",'<div class="carousel-inner" role="listbox">',"{{each list as url}}",'<div class="item {{if index==$index}}active{{/if}}">','<img src="{{url}}">',"</div>","{{/each}}","</div>",'<a class="left carousel-control" href="#cb_cccc" role="button" data-slide="prev">','<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>','<span class="sr-only">Previous</span>',"</a>",'<a class="right carousel-control" href="#cb_cccc" role="button" data-slide="next">','<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>','<span class="sr-only">Next</span>',"</a>","</div>"].join("");o=template.compile(o)({list:a,index:e}),t.dialog.show({body:o,foot:!1,"class":"hw-carousel",title:""})},confirm:function(e){var a={title:e.msg,body:!1,NoText:"取消",YesText:e.YesText||"确认","class":"hw-confirm",YesFn:e.YesFn};e.title&&(a.title=e.title,a.body=e.msg),t.dialog.show(a)},confirm1:function(e){var a={title:e.msg,body:!1,NoText:"取消",YesText:e.YesText||"确认","class":"hw-confirm1",YesFn:e.YesFn};t.dialog.show(a)},showQrCode:function(e){var a='<div class="hw-qr"><img src="'+t.getQrCode(e,200)+'" /></div>';t.dialog.show({body:a,title:"打开微信扫一扫以下二维码即可打开本店页面，点击屏幕右上角分享按钮",foot:!1,"class":"hw-dialog-qrcode"})}},t.alert=function(e){t.dialog.show({body:e,NoText:"确定",YesText:!1})},t.url={param:function(e,t){t=t||location.search,e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var a=new RegExp("[\\?&]"+e+"=([^&#]*)"),o=a.exec(t);return null===o?"":decodeURIComponent(o[1].replace(/\+/g," "))}},window.util=KG.util=t}(),function(){template.helper("absImage",function(e){return/^http/.test(e)?e:KG.config.SiteRoot+e}),template.helper("formatDate",function(e,t){return util.formatDate(e,t||"yy年mm月dd日 h:m:s")}),template.helper("storeFullAddress",function(e){return e.address+", "+e.city+", "+e.state+" "+e.zip}),template.helper("defaultUserImage",function(e){return e?e:KG.user.get("defaultImage")}),template.helper("decode",function(e){return decodeURIComponent(e)})}();
